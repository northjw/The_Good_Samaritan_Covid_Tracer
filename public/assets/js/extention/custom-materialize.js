...
(function (factory) {
   ...
   fn.extend({
      data: function (name, value) {
         if (isString(name)) {
            return value === undefined ? getData(this[0], name) : this.each((v) => {
   ...
   fn.extend({
      ...
      filter: function (selector) {
         ...
         return cash(filter.call(this, (e) => {
   ...
   const camelCase = function () {
      const camelRegex = /(?:^\w|[A-Z]|\b\w)/g,
         whiteSpace = /[\s-_]+/g;
      return function (str) {
         return str.replace(camelRegex, (letter, index) => {
   ...
   fn.extend({
      css: function (prop, value) {
         if (isString(prop)) {
            ...
            return arguments.length > 1 ? this.each((v) => {
...
$jscomp.initSymbolIterator = function () {
   $jscomp.initSymbol();let e = $jscomp.global.Symbol.iterator;e || (e = $jscomp.global.Symbol.iterator = $jscomp.global.Symbol("iterator"));typeof Array.prototype[e] !== "function" && $jscomp.defineProperty(Array.prototype, e, { configurable: !0, writable: !0, value: function () {
      return $jscomp.arrayIterator(this);
   } });$jscomp.initSymbolIterator = function () {};
};$jscomp.arrayIterator = function (e) {
   let r = 0;return $jscomp.iteratorPrototype(() => {
...
};$jscomp.polyfill("Array.prototype.keys", (e) => {
   return e ? e : function () {
...
(function (r) {
   ...
   function e(a) {
      ...
      function c(a, c, b) {
         b < 0 && (b += 1);b > 1 && --b;return b < 1 / 6 ? a + 6 * (c - a) * b : b < .5 ? c : b < 2 / 3 ? a + (c - a) * (2 / 3 - b) * 6 : a;
      ...
      const d = /^(\*=|\+=|-=)/.exec(a);if (!d) {return a;}const b = y(a) || 0;c = parseFloat(c);a = parseFloat(a.replace(d[0], ""));switch (d[0][0]) {case "+":
         return c + a + b;case "-":
         return c - a + b;case "*":
         return c * a + b;}
   }function F(a, c) {
      ...
      a = a ? p(h.arr(a) ? a.map(m) : m(a)) : [];return r(a, (a, d, b) => {
         return b.indexOf(a) === d;
      });
   }function Z(a) {
      const c = P(a);return c.map((a, b) => {
      ...
      let d = {},
         b;for (b in a) {
         let f = I(a[b], c);h.arr(f) && (f = f.map((a) => {
            return I(a, c);
      ...
      const f = a === "delay";return c.length ? (f ? Math.min : Math.max).apply(Math, c.map((b) => {
         return b[a];
      ...
      function c() {
         return window.Promise && new Promise((a) => {
            return p = a;
         });
      }function d(a) {
      ...
      A = function () {
         function a(a, d, b) {
            ...
            if (c >= 0 && c <= 1 && b >= 0 && b <= 1) {
               const e = new Float32Array(11);if (c !== d || b !== f) {for (let k = 0; k < 11; ++k) {
                  e[k] = a(.1 * k, c, b);
               }}return function (k) {
      ...
      Q = function () {
         function a(a, b) {
            ...
            d = { In: [[.55, .085, .68, .53], [.55, .055, .675, .19], [.895, .03, .685, .22], [.755, .05, .855, .06], [.47, 0, .745, .715], [.95, .05, .795, .035], [.6, .04, .98, .335], [.6, -.28, .735, .045], a], Out: [[.25, .46, .45, .94], [.215, .61, .355, 1], [.165, .84, .44, 1], [.23, 1, .32, 1], [.39, .575, .565, 1], [.19, 1, .22, 1], [.075, .82, .165, 1], [.175, .885, .32, 1.275], function (b, c) {
               ...
               return b < .5 ? a(2 * b, c) / 2 : 1 - a(-2 * b + 2, c) / 2;
            }] },
   ...
   */
   ...
   const Dropdown = function (_Component2) {
      ...
      function Dropdown(el, options) {
         ...
         const _this9 = _possibleConstructorReturn(this, (Dropdown.__proto__ || Object.getPrototypeOf(Dropdown)).call(this, Dropdown, el, options));
       ...
       */
         ...
         value: function _makeDropdownFocusable() {
            ...
            $(this.dropdownEl).children().each((el) => {
         ...
         value: function _getDropdownPosition() {
            ...
            const closestOverflowParent = !!this.dropdownEl.offsetParent ? this.dropdownEl.offsetParent : this.dropdownEl.parentNode;
   ...
   const Modal = function (_Component3) {
     ...
     */
      function Modal(el, options) {
         ...
         const _this13 = _possibleConstructorReturn(this, (Modal.__proto__ || Object.getPrototypeOf(Modal)).call(this, Modal, el, options));
   ...
   const Materialbox = function (_Component4) {
     ...
     */
      function Materialbox(el, options) {
         ...
         const _this16 = _possibleConstructorReturn(this, (Materialbox.__proto__ || Object.getPrototypeOf(Materialbox)).call(this, Materialbox, el, options));
...
(function ($) {
   ...
   const Parallax = function (_Component5) {
      ...
      function Parallax(el, options) {
         ...
         const _this21 = _possibleConstructorReturn(this, (Parallax.__proto__ || Object.getPrototypeOf(Parallax)).call(this, Parallax, el, options));
   ...
   const Tabs = function (_Component6) {
     ...
     */
      function Tabs(el, options) {
         ...
         const _this22 = _possibleConstructorReturn(this, (Tabs.__proto__ || Object.getPrototypeOf(Tabs)).call(this, Tabs, el, options));
   ...
   const Tooltip = function (_Component7) {
     ...
     */
      function Tooltip(el, options) {
         ...
         const _this26 = _possibleConstructorReturn(this, (Tooltip.__proto__ || Object.getPrototypeOf(Tooltip)).call(this, Tooltip, el, options));
   ...
   const Sidenav = function (_Component8) {
     ...
     */
      function Sidenav(el, options) {
         ...
         const _this31 = _possibleConstructorReturn(this, (Sidenav.__proto__ || Object.getPrototypeOf(Sidenav)).call(this, Sidenav, el, options));
   ...
   const ScrollSpy = function (_Component9) {
     ...
     */
      function ScrollSpy(el, options) {
         ...
         const _this35 = _possibleConstructorReturn(this, (ScrollSpy.__proto__ || Object.getPrototypeOf(ScrollSpy)).call(this, ScrollSpy, el, options));
       ...
       */
         ...
         value: function _enter() {
            ScrollSpy._visibleElements = ScrollSpy._visibleElements.filter((value) => {
   ...
   const Autocomplete = function (_Component10) {
     ...
     */
      function Autocomplete(el, options) {
         ...
         const _this37 = _possibleConstructorReturn(this, (Autocomplete.__proto__ || Object.getPrototypeOf(Autocomplete)).call(this, Autocomplete, el, options));
   ...
   const Slider = function (_Component11) {
     ...
     */
      function Slider(el, options) {
         ...
         const _this40 = _possibleConstructorReturn(this, (Slider.__proto__ || Object.getPrototypeOf(Slider)).call(this, Slider, el, options));
       ...
       */
         ...
         _this40.activeIndex = _this40.$slides.filter((item) => {
   ...
   const Chips = function (_Component12) {
     ...
     */
      function Chips(el, options) {
         ...
         const _this45 = _possibleConstructorReturn(this, (Chips.__proto__ || Object.getPrototypeOf(Chips)).call(this, Chips, el, options));
   ...
   const Pushpin = function (_Component13) {
     ...
     */
      function Pushpin(el, options) {
         ...
         const _this47 = _possibleConstructorReturn(this, (Pushpin.__proto__ || Object.getPrototypeOf(Pushpin)).call(this, Pushpin, el, options));
   ...
   const FloatingActionButton = function (_Component14) {
     ...
     */
      function FloatingActionButton(el, options) {
         ...
         const _this48 = _possibleConstructorReturn(this, (FloatingActionButton.__proto__ || Object.getPrototypeOf(FloatingActionButton)).call(this, FloatingActionButton, el, options));
   ...
   const Datepicker = function (_Component15) {
     ...
     */
      function Datepicker(el, options) {
         ...
         const _this53 = _possibleConstructorReturn(this, (Datepicker.__proto__ || Object.getPrototypeOf(Datepicker)).call(this, Datepicker, el, options));
       ...
       */
         ...
         value: function toString(format) {
            ...
            const formattedDate = formatArray.map((label) => {
   ...
   */
   ...
   const Timepicker = function (_Component16) {
      ...
      function Timepicker(el, options) {
         ...
         const _this57 = _possibleConstructorReturn(this, (Timepicker.__proto__ || Object.getPrototypeOf(Timepicker)).call(this, Timepicker, el, options));
   ...
   const CharacterCounter = function (_Component17) {
     ...
     */
      function CharacterCounter(el, options) {
         ...
         const _this61 = _possibleConstructorReturn(this, (CharacterCounter.__proto__ || Object.getPrototypeOf(CharacterCounter)).call(this, CharacterCounter, el, options));
   ...
   const Carousel = function (_Component18) {
     ...
     */
      function Carousel(el, options) {
         ...
         const _this62 = _possibleConstructorReturn(this, (Carousel.__proto__ || Object.getPrototypeOf(Carousel)).call(this, Carousel, el, options));
   ...
   const TapTarget = function (_Component19) {
     ...
     */
      function TapTarget(el, options) {
         ...
         const _this67 = _possibleConstructorReturn(this, (TapTarget.__proto__ || Object.getPrototypeOf(TapTarget)).call(this, TapTarget, el, options));
   ...
   const FormSelect = function (_Component20) {
     ...
     */
      function FormSelect(el, options) {
         ...
         const _this68 = _possibleConstructorReturn(this, (FormSelect.__proto__ || Object.getPrototypeOf(FormSelect)).call(this, FormSelect, el, options));
       ...
       */
         ...
         value: function _setupDropdown() {
               ...
               this.$selectOptions.each((el) => {
                  if ($(el).is("option")) {
                     ...
                     selectOptions.each((el) => {
                        const optionEl = _this71._appendOptionWithIcon(_this71.$el, el, "optgroup-option");
                        _this71._addOptionToValueDict(el, optionEl);
                     });
                  }
               });
            ...
            // Add input dropdown
            const placeholder = this.$el[0].getAttribute("data-placeholder");
            ...
            // Add caret
            const dropdownIcon = $("<svg class=\"caret\" height=\"24\" viewBox=\"0 0 24 24\" width=\"24\" xmlns=\"http://www.w3.org/2000/svg\"><path d=\"M16.59 8.59L12 13.17 7.41 8.59 6 10l6 6 6-6z\"/></svg>");
            ...
            if (!this.el.disabled) {
               ...
               dropdownOptions.onOpenEnd = function (el) {
                  const selectedOption = $(_this71.dropdownOptions).find(".selected").first();
   ...
   const Range = function (_Component21) {
     ...
     */
      function Range(el, options) {
         ...
         const _this72 = _possibleConstructorReturn(this, (Range.__proto__ || Object.getPrototypeOf(Range)).call(this, Range, el, options));
